      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl items-center px-4 sm:px-6 lg:px-8">
        <div className="grid w-full gap-12 pt-20 pb-12 lg:grid-cols-2 lg:gap-16 lg:pt-0">
          ...
          <div className="flex flex-col justify-center">
            ...
            >
              <span className="font-inter text-sm text-white/60">Follow Us:</span>
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="rounded-full bg-gradient-to-br from-pink-500 via-purple-500 to-indigo-600 p-3 text-white shadow-lg transition-all hover:shadow-xl"
              >
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.2, rotate: -10 }}
                whileTap={{ scale: 0.95 }}
                className="rounded-full bg-blue-600 p-3 text-white shadow-lg transition-all hover:shadow-xl"
              >
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            <div className="relative">
              ...
              <div className="relative h-[400px] w-[350px] overflow-hidden rounded-3xl border border-white/20 shadow-2xl">
                <img
                  src="/images/students-speaking.png"
                  alt="Students"
                  className="h-full w-full object-cover"
                />
